...
//
//	mockgen -source=internal/auth/service/service.go -destination=internal/auth/service/mocks/mocks.go -package=mocks UserStore,SessionStore,AuthCodeStore,RefreshTokenStore,TokenGenerator,AuditPublisher,ClientResolver
//
