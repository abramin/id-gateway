Feature: Rate Limiting & Abuse Prevention
  ...
  @ratelimit @algorithm @simulation
  ...
  @ratelimit @allowlist @admin @simulation
  ...
  @ratelimit @quota @partner @simulation
